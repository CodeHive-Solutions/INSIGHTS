...
class Payslip(models.Model):
    ...
    night_shift_hours = models.DecimalField(max_digits=12, decimal_places=2)
    ...
    night_shift_overtime_allowance = models.DecimalField(max_digits=12, decimal_places=2)
    night_shift_holiday_hours = models.DecimalField(max_digits=12, decimal_places=2)
    night_shift_holiday_allowance = models.DecimalField(max_digits=12, decimal_places=2)
